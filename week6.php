...
<input type="text" class="form-control" name="user_phone" placeholder="Enter Prodi" maxlength="20" required>
</div>
</div>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					...
					<div class='col-sm-3 col-md-6'>
						...
						<h3 class='text-primary'>Prodi : $phone</h3>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<div class='form-group col-md-6'>
		<label for='inputPassword4'>Prodi</label>
		<input type='phone' class='form-control' name='user_phone' placeholder='Enter Prodi' maxlength='20' value='$phone' required>
		</div>
		</div>
